  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <Link href="/dashboard/family" className="group bg-gradient-to-br from-purple-400 to-indigo-500 p-6 rounded-2xl shadow-md hover:shadow-xl transition-all duration-200 hover:scale-105">
          <svg className="w-6 h-6 text-white/80 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
