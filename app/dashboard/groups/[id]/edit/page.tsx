  ...
  const loadGroup = async () => {
    ...
    try {
      ...
      if (!membership || membership.role !== 'admin') {
        setError('You must be an admin to edit this group')
        setLoading(false)
        return
      }
      ...
      setCurrentLogoUrl(groupData.logo_url)
      setPrivacyLevel(groupData.privacy_level)
      setLoading(false)
    } catch (err) {
    ...
    try {
      ...
      if (logoFile) {
        ...
        if (currentLogoUrl) {
          ...
          if (oldPath) {
            await supabase.storage.from('group-logos').remove([`group-logos/${oldPath}`])
          }
        }
      }

      // Update the umbrella group
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 p-6">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2">Update your group settings</p>
        </div>
